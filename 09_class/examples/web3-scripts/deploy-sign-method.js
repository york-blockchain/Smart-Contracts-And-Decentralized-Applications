// Inject environment variable in this file
...
const { bytecode } = require("./bytecode"); // compiled code
...
const contractData = simplestorageContract // deployment code
  .deploy({
    data: `0x${bytecode}`,
    arguments: [_number],
  })
...
// deployed another on 0x979873950d9C11B98B6884783Ec2340aEfc7059D at rinkeby